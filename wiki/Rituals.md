...
| Ritual of Harvest (*The Reaper's Bounty*) | Reaps and replants mature crops. Drops go into a container directly above the Master Ritual Stone, or onto the ground if there is none. **Cost:** 3 EV per crop harvested, charged only when something is actually reaped; an idle field costs nothing. Refreshes every 20 ticks (1 s). If the output container has no free slot the ritual waits and charges nothing. |
...
| Ritual of Overgrowth (*Verdant Awakening*) | Suffuses the earth with life, hastening all growth. Crops, saplings, cactus, sugar cane, bamboo, budding amethyst and Spiritus crystals in range all receive growth ticks. **Cost:** 20 EV per growth tick applied, charged only when a block actually grows; nothing in range means no drain. Refreshes every 20 ticks (1 s), quickened to 10 ticks by **Raw Spiritus** in the chunk. **Spiritus Invictus** hydrates farmland, **Spiritus Ruina** afflicts nearby mobs with Plant Leech, and **Spiritus Vindicta** scales the chance each block is grown. |
